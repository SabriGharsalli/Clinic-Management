...
public class Principalinter extends JFrame implements ActionListener {
    ...
    JMenuItem it1= new JMenuItem("Ordonnance");
    JMenuItem it2 = new JMenuItem("Consultation");
    JMenuItem it3 = new JMenuItem("Patient");
    JMenuItem it4= new JMenuItem("Fiche");
    JMenuItem it5= new JMenuItem("Patient");
    JMenuItem it6 = new JMenuItem("Consultation");
    JMenuItem it7 = new JMenuItem("Fiche");
    JMenuItem it8= new JMenuItem("Ordonnance");
